          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                max={new Date().toISOString().split("T")[0]}
                className={`w-full px-4 py-3 cursor-pointer rounded-lg focus:ring-2 focus:ring-indigo-500 transition
                ${
                  softDark
            ...
            <div>
              ...
              {categoriesLoading ? (
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className={`w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-indigo-500 transition
                  ${
                    softDark
                      ? "bg-gray-600 border border-gray-500 text-gray-100"
                      : "bg-white border border-gray-300 text-gray-800"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Add a note about this transaction..."
                rows="4"
                className={`w-full px-4 py-3 rounded-lg resize-none focus:ring-2 focus:ring-indigo-500 transition
                ${
                  softDark
                    ? "bg-gray-600 border border-gray-500 text-gray-100"
                    : "bg-white border border-gray-300 text-gray-800"
            ...
            <button
              type="submit"
              disabled={loading || categoriesLoading}
              className={`w-full py-4 rounded-lg font-semibold flex items-center justify-center transition-all shadow-lg
              ${
                softDark
